...
| 6 | Productivity Suite + Infrastructure Planning | Time tracking, calendar, performance metrics, infra research, workflow builder UX redesign | Timer, calendar sync, performance trends, infra report, node config decomposition | COMPLETE | Q1–Q2 2026 |
| 7 | Design Partner Readiness | Client portals, entity dropdowns, timer relocation, Google OAuth | Portal accessible, fields as dropdowns, timer in Time tab, OAuth guide | ACTIVE | Q2 2026 |
| 8 | Enterprise, Scale & Compliance | Temporal, SOC 2, multi-region, marketplace | ≥5 paying, SOC 2 in progress | FUTURE | Q3–Q4 2026 |
...
| Area | Owner Role | PRD Doc | P1 | P2 | P3 | P4 | P5 | P6 | P7 | P8 |
|------|-----------|---------|----|----|----|----|----|----|-----|-----|
| Core data model (Blocks, Events, Actions) | Backend Engineer | prd/04-data-models.md | Heavy | Medium | Light | Light | Light | — | Light | Light |
| Custom block types | Backend Engineer | prd/04-data-models.md | — | Heavy | Light | — | Medium | — | Medium | — |
| API and services | Backend Engineer | prd/05-api-contracts.md | Heavy | Heavy | Medium | Medium | Medium | Light | Medium | Medium |
...
| Frontend (dashboard + block views) | Frontend Engineer | prd/06-frontend-spec.md | Heavy | Medium | Medium | Light | Medium | Medium | Medium | Light |
| Auth + multi-tenancy | Backend Engineer | prd/10-security-compliance.md | Heavy | Light | Light | — | Light | — | Light | Medium |
...
| Integration layer (webhooks + connectors) | Backend Engineer | prd/05-api-contracts.md, prd/09-data-pipeline.md | — | Medium | Heavy | Medium | Light | — | Light | Medium |
| Document generation | Backend + Frontend | prd/06-frontend-spec.md | — | — | Medium | Medium | — | — | — | — |
| Security + compliance | All roles | prd/10-security-compliance.md | Medium | Medium | Medium | — | — | — | Light | Heavy |
| User research + design partners | Researcher + PM | prd/02-user-research.md | Heavy | Medium | Light | Light | — | — | Medium | Light |
| Client portal + forms | Frontend + Backend | prd/06-frontend-spec.md | — | — | — | Heavy | — | — | **Heavy** | Light |
...
**Phase 7 — Design Partner Readiness** (Sprint 24)

Phases 1–6 code-complete. Phase 7 builds client-facing capabilities needed before engaging design partners.

| Milestone | Status |
|-----------|--------|
| WS4: Google OAuth setup guide + granular consent | **COMPLETE** |
| WS3: Timer widget relocation to My Work Time tab | **COMPLETE** |
| WS2: Entity dropdown fields (multi-relation, 7 conversions, UX) | **COMPLETE** |
| WS1: Client Portal System (foundation + UI + API + admin) | **COMPLETE** |

**WS1 delivered:** portal_configurations table, form_template block type (12 question types + decision-tree branching), 7 public API endpoints, 5 portal UI pages (branded dashboard, documents hub, request intake, form filling), admin config panel. New DB objects: portal_configurations table, shared_links.portal_config_id, form_submissions.form_template_id.

**WS2 delivered:** multi-relation field type, MultiRelationField component, 7 system type field conversions, searchable RelationField with combobox.

**Previous (Phase 6):** Productivity Suite (S18–S21, 37/37) + Workflow Builder UX Redesign (S22–S23, 23/23). 60/60 tasks, 1746 tests.
...
| 2026-03-18 | Phase 6 marked COMPLETE (60/60 tasks, 1746 tests). Phase 7 "Design Partner Readiness" activated: client portals, entity dropdown fields, timer relocation, Google OAuth. Enterprise phase renumbered to Phase 8. Phase table expanded to P1–P8. | Pre-design-partner feature gap analysis | PM + ORCHESTRATOR |
